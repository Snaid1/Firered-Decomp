const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_WHIRLWIND] =
    {
        .effect = EFFECT_ROAR, //EFFECT_ROAR changed from accuracy check to always work if allowed.
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0, //0 shows up as --- in game, aka auto hit.
        .pp = 20,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .priority = -6,
    ...
    [MOVE_BIDE] =
    {
        ...
        .power = 1,
        .type = TYPE_NORMAL,
        .accuracy = 0, //TEST TO CONFIRM AUTO HIT
        .pp = 10,
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_USER,
        .priority = 0,
    ...
    [MOVE_BEAT_UP] =
    {
        .effect = EFFECT_BEAT_UP, //Not updated
        .power = 10,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 10,
