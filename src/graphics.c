...
const u8 gMoveCategoryIcons_Gfx[] = INCBIN_U8("graphics/interface/split_icons_battle.4bpp");
const u16 gMoveCategoryIcons_Pal[] = INCBIN_U16("graphics/interface/split_icons_battle.gbapal");
